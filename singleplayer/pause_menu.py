...
class PauseMenu:
    def __init__(self, screen):
        ...
        self.surf.fill((30, 30, 30, 128))  # Pre-fill the background

    def draw(self):
        self.surf.fill((30, 30, 30, 128))  # Clear previous frame
        ...
        for i, option in enumerate(self.options):
            ...
            pygame.draw.rect(self.surf, (50, 50, 50, 200), rect, border_radius=10)
            pygame.draw.rect(self.surf, (255, 255, 255, 255), rect, 2, border_radius=10)
